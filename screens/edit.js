...
export default function Edit(props) {
  ...
  const [cat_birthdate, setCatBirthdate] = useState("");
  ...
  const onSubmitFormHandler = async (event) => {
    if (
      ...
      try {
        const response = await axios.post(`${baseUrl}addCat`, {
          user_id: user_id,
          cat_name,
          cat_gender,
          cat_breed,
      ...
      <View style={styles.form_container}>
        <View style={styles.details_container}>
          ...
          <View style={styles.input_container}>
            ...
            {/* <TextInput style={styles.input} placeholder="Gender" value={cat_gender} onChangeText={onChangeCatGenderHandler} /> */}
